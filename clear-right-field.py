...
async def main():
    ...
    await move_straight(24, 400)
    await turn_for_degrees(75, 200)
    await move_straight(6.5, 400)
    await turn_for_degrees(80, 200)
    await move_straight(-2, 400)
    await turn_for_degrees(45, 200)
    await move_straight(26, 400)
